...
setup(
    name="prefect-writer",
    description="Prefect integrations with Writer",
    license="Apache License 2.0",
    author="Nick Acosta",
    author_email="nick.acosta1@gmail.com",
    keywords="prefect",
    url="https://github.com/pubchimps/prefect-writer",
